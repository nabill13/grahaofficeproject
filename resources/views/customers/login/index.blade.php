...
<body id="login_bg">
    ...
    <div id="login">
        <aside>
            <figure>
                <a href="/"><img src="{{ url('') }}/img/logo-sticky1.png" width="200" height="45" data-retina="true"
            ...
            <form action="/login/req" method="POST">
                ...
                <button type="submit" class="btn_1 rounded full-width">Login to GrahaOffice</button>
                <div class="text-center add_top_10">New to GrahaOffice? <strong><a href="/register">Sign
                            up!</a></strong></div>
            </form>
